...
public class GradientShader {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("Leapfrog/Shaders/gradientMask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("Leapfrog/Shaders/gradient.frag");
