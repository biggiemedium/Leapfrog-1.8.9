...
import dev.px.leapfrog.Client.GUI.ClickGUI.Components.Panels.ColorsPanel;
...
public class ColorsScreen extends Screen {
    ...
    public ColorsScreen(int x, int y, int width, int height, ClickGUI clickGUI) {
        ...
        this.panel = new ColorsPanel(getX() + 8, getY() + 90, getWidth() - 16, 60, new Color(26, 26, 26), this);
    }
    ...
    public void render(int mouseX, int mouseY) {
        ...
        FontUtil.regular_bold26.drawString(color.getName(), (getX() + 8) + 46, (getY() + 36) + 6, -1);
